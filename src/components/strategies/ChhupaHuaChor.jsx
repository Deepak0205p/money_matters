    ...
    >
      ...
      <div className="text-center space-y-1">
        <h2 className="text-2xl md:text-3xl font-black text-red-400 flex items-center justify-center gap-2">
           <Skull className="animate-bounce text-red-500" size={28} /> The Hidden Thief (Inflation)
        </h2>
        <p className="text-xs text-zinc-400">Silent money killer simulator. See how inflation eats your savings!</p>
      </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-zinc-300 font-medium mt-0.5">
                Inflation has destroyed your cash's buying power by <span className="text-red-400 font-black">{Math.round(animatedLostPct)}%</span>!
              </p>
            </div>
          </motion.div>
        )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-xs text-zinc-400">Money locked in a safe — no interest earned, no tax paid.</p>
        ...
        >
          ...
          <p className="text-xs text-zinc-400">Money grown with compounding returns at 12% per year.</p>
          <div className="mt-4 space-y-2">
            <div className="flex justify-between text-xs">
      ...
      <div className="space-y-4">
        <div className="glass rounded-2xl p-4 flex items-start gap-3 border border-white/[0.05]">
          ...
          <div className="space-y-1">
            <p className="text-xs text-white font-extrabold">💡 Strategy to Beat the Thief:</p>
            <p className="text-[11px] text-zinc-400 leading-relaxed">
              The only way to beat inflation is: invest in assets that can give returns higher than the inflation rate (6%).
              If you keep cash in an almirah, its purchasing power will vanish. But regular investment (Equity, Mutual Funds) grows your wealth beyond inflation through compounding.
            </p>
          </div>
        </div>
        ...
        >
          <Shield size={16} /> Learned to Beat Inflation! +15 Coins
        </motion.button>
      </div>
    </div>
  );
