...
export default function DailySimulator() {
  ...
  const savingsTip = useMemo(() => {
    ...
    if (totalSpent <= DAILY_BUDGET) {
      return `If you save this much daily, you'll save ${formatCurrency(monthlyExtra)} per month — put that in a SIP and in 10 years you'll have ${formatCurrency(Math.round(monthlyExtra * 230))}+!`;
    }
    return `If you overspend like this daily, you'll have a ${formatCurrency(monthlyExtra)} deficit per month! Put it on a credit card and you'll pay 36% interest!`;
  }, [totalSpent]);
  ...
  if (isComplete) {
    ...
    return /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx(motion.div, {
        ...
        children: isPositive ? 'Day in Savings! 🎉' : 'Budget Over! 😱'
      }), /*#__PURE__*/_jsx("div", {
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        ...
        children: "One day's budget — make smart choices!"
      })]
    }), /*#__PURE__*/_jsxs("div", {
          ...
          children: /*#__PURE__*/_jsx(Card, {
            ...
            children: /*#__PURE__*/_jsxs(CardContent, {
              ...
              children: [/*#__PURE__*/_jsxs("div", {
                ...
                children: [currentStep + 1 >= dailyChoices.length ? 'Day Summary \u2192' : 'Next Decision \u2192', /*#__PURE__*/_jsx(ChevronRight, {
                  size: 14,
                  className: "ml-1"
                })]
              })]
