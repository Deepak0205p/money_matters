    ...
    <div className="flex flex-col w-full max-w-4xl mx-auto px-3 sm:px-4 py-4 gap-5">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-xl sm:text-2xl font-black text-white">
          Money Dictionary <span className="text-amber-400">📖</span>
        </h2>
        <p className="text-sm text-zinc-400">
          Understand financial terms simply — {masteredCount}/{totalTerms} mastered!
        </p>
        {/* Progress bar */}
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        ...
        {filteredTerms.length === 0 && (
          <div className="text-center py-12 w-full text-zinc-500">
            ...
            <p className="text-sm">No term found — try a different search!</p>
          </div>
        )}
      </div>
