...
export default function InflationMonster() {
  ...
  const insightText = useMemo(() => {
    if (years <= 3) return `${years} years — inflation has started slowly eating your money!`;
    if (years <= 7) return `${years} years — inflation has eaten a lot of your money! Investing is essential.`;
    if (years <= 12) return `${years} years — inflation has eaten more than half the value! Without investing, money is melting!`;
    if (years <= 17) return `${years} years — inflation has wreaked havoc! Only ${Math.round(realValue)} is left out of ${amount}!`;
    return `${years} years — inflation ate half the money! ${formatCurrency(amount)} is now just ${formatCurrency(Math.round(realValue))}! Investing turned it into ${formatCurrency(Math.round(investedValue))}!`;
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        className: "text-xl sm:text-2xl font-bold text-gradient-gold mb-1",
          children: "The Hidden Thief 🧛"
      }), /*#__PURE__*/_jsx("p", {
        className: "text-sm text-[#a0a0b8] font-medium",
        children: "Inflation is the thief, investing is the hero — watch how!"
      })]
    }), /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx(CoinStack, {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [/*#__PURE__*/_jsx(TrendingDown, {
                ...
                children: ["-", Math.round(chorAte / amount * 100), "% eaten"]
              })]
            })]
          })]
        })]
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [/*#__PURE__*/_jsx(TrendingUp, {
                ...
                children: ["+", Math.round(heroGained / amount * 100), "% growth"]
              })]
            })]
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [formatCurrency(amount), " after ", years, " years becomes?"]
      }), /*#__PURE__*/_jsxs("div", {
