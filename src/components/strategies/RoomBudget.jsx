...
export default function RoomBudget() {
  ...
  const budgetHealth = useMemo(() => {
    ...
    if (avgDiff <= 5) return {
      level: 'excellent',
      color: '#22c55e',
      label: 'Excellent! Following the 50/30/20 rule!'
    };
    if (avgDiff <= 15) return {
      level: 'good',
      color: '#f59e0b',
      label: 'Good! Adjust a little and it will be perfect!'
    };
    return {
      level: 'poor',
      color: '#ef4444',
      label: 'Fix your budget! You\'re far from the 50/30/20 rule!'
    };
  }, [percentages]);
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        ...
        children: "See your budget laid out in your room \u2014 every expense has its place!"
      }), /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs(CardContent, {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsx("span", {
                ...
                children: [formatCurrency(template.income), "/month"]
              })]
            }), /*#__PURE__*/_jsx("div", {
