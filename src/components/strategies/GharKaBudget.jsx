...
export default function GharKaBudget() {
  ...
  const healthLabel = health >= 75 ? 'Absolutely Perfect!' : health >= 45 ? 'Needs Improvement' : 'Dangerous!';

  // Tip generation
  const tips = useMemo(() => {
    const t = [];
    if (budget.rent > SALARY * 0.35) t.push('🏢 Rent is too high. Try PG or sharing.');
    if (budget.food > SALARY * 0.3) t.push('🍔 Cut down on eating out. Meal prep saves 40%.');
    if (budget.entertainment > SALARY * 0.15) t.push('🎬 Fun budget is a bit high. Explore free activities.');
    if (budget.transport > SALARY * 0.15) t.push('🚌 Get a Metro/PUC pass. Daily autos are expensive.');
    if (savingsPct < 20) t.push('🐷 Buddy, save something for the future! 20% is the minimum target.');
    if (t.length === 0) t.push('✨ Great! Your budget is perfectly balanced!');
    return t;
  }, [budget, savingsPct]);
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx("h3", {
            ...
            children: "Changes based on budget"
          })]
        }), /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: remaining < 0 && /*#__PURE__*/_jsxs(motion.div, {
              ...
              children: [/*#__PURE__*/_jsx(AlertTriangle, {
                className: "w-4 h-4"
              }), "Spending exceeds salary! Cut ₹", Math.abs(remaining).toLocaleString('en-IN'), "."]
            })
            ...
            className: "mt-2 p-2 rounded-lg bg-amber-500/15 border border-amber-500/30 text-xs text-amber-300 flex items-center gap-2",
              children: [/*#__PURE__*/_jsx(AlertTriangle, {
                className: "w-4 h-4"
              }), "Buddy, save something for the future! Target 20%."]
          }), savingsPct >= 20 && remaining >= 0 && /*#__PURE__*/_jsxs("div", {
            className: "mt-2 p-2 rounded-lg bg-emerald-500/15 border border-emerald-500/30 text-xs text-emerald-300 flex items-center gap-2",
              children: [/*#__PURE__*/_jsx(CheckCircle2, {
                className: "w-4 h-4"
              }), "You're doing great! Savings ", savingsPct.toFixed(0), "% 👏"]
          })]
        })]
      })]
    }), /*#__PURE__*/_jsxs("div", {
