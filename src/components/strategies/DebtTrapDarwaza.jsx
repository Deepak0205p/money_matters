...
const DOORS = [{
  ...
  emoji: '📱',
  danger: 2,
  scenario: '₹80,000 phone, 12-month EMI. Didn\'t realize you\'re paying ₹10,000 extra in interest!',
  math: '₹80,000 phone → Total paid: ₹90,000 (12% interest)',
  tip: 'Buy phones with full payment, or EMI under 6 months. Longer tenure = more interest.'
}, {
  id: 2,
  title: 'Credit Card Web',
  emoji: '💳',
  danger: 3,
  scenario: 'Paying only the minimum due? The real amount grows at 36-45% interest. Death spiral!',
  math: '₹50,000 due → Min pay 5% = ₹2,500/mo. Clear karne mein 8+ saal, total ₹1,10,000+.',
  tip: 'Always pay the FULL amount. Credit card = free 50-day loan ONLY if you pay in full.'
}, {
  id: 3,
  title: 'Buy Now Pay Later',
  emoji: '🛒',
  danger: 2,
  scenario: 'BNPL apps show "0% interest" but hide late fees and convenience charges.',
  math: '₹5,000 item → Late fee ₹500 + ₹200 charge = 14% extra in 1 month.',
  tip: 'Use BNPL only when you\'re sure you can pay within 30 days. Otherwise avoid.'
}, {
  id: 4,
  title: 'Personal Loan Trap',
  emoji: '🏦',
  danger: 3,
  scenario: 'Personal loan at 18-24% interest. A festival loan = 5 years of pain.',
  math: '₹2,00,000 loan @ 22% × 5 yr = Total payback ₹3,32,000.',
  tip: 'Personal loan only for emergencies. Never for vacations/weddings.'
}, {
  id: 5,
  title: '0% EMI Illusion',
  emoji: '🎭',
  danger: 2,
  scenario: '"0% interest" EMI actually has the product price already inflated by 10-15%.',
  math: '₹40,000 AC cash = ₹34,000. EMI mein ₹40,000 + processing ₹1,500 = hidden 18%.',
  tip: 'Compare cash discount with EMI price. Real savings will show.'
}, {
  id: 6,
  title: 'Lifestyle EMI',
  emoji: '🏠',
  danger: 1,
  scenario: 'Furniture, appliances, wedding — all on EMI. Entire income goes to EMIs.',
  math: '3 EMIs × ₹5,000 = ₹15,000/mo. 40% salary chali gayi, savings zero.',
  tip: 'Total EMI should never exceed 30% of income. 20% is the safe zone.'
}, {
  id: 7,
  title: 'Payday Loan',
  emoji: '💸',
  danger: 3,
  scenario: '7-day payday loan at 1-2% per DAY interest. Annual = 365-730%. Most dangerous!',
  math: '₹10,000 × 1.5% × 30 days = ₹4,500/month interest. Year mein ₹54,000.',
  tip: 'Payday loans are a TRAP. Better try a gold loan or ask family for help.'
}];
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx(motion.h2, {
        ...
        children: "Debt Trap Door 💀"
      }), /*#__PURE__*/_jsx("p", {
        className: "text-zinc-500 mt-2 text-sm",
        children: "7 doors — each one a debt trap. Open them, understand, and stay safe."
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: allDone && /*#__PURE__*/_jsxs(motion.div, {
        ...
        children: [/*#__PURE__*/_jsx(motion.div, {
          ...
          children: "You explored all 7 doors \u2014 now you're safe from the debt trap!"
        }), /*#__PURE__*/_jsx("div", {
          className: "mt-4 grid sm:grid-cols-2 gap-2 text-left",
          children: ['💰 Keep total EMI under 30% of salary', '💳 Always pay credit card in FULL', '🚫 Personal loan only for emergencies', '🔍 Check for hidden charges in "0% EMI"', '📅 Never take payday loans', '🎯 Savings first, expenses later', '📊 Review your debt every month'].map((r, i) => /*#__PURE__*/_jsxs(motion.div, {
            initial: {
              opacity: 0,
              x: -10
            },
