...
export default function ReportCard() {
  ...
  const subjects = useMemo(() => {
    ...
    return [{
      ...
      tip: 'Complete modules — each module gives you ₹50!'
    }, {
      name: 'Budget Planning',
      emoji: '📊',
      score: budget,
      tip: 'Take quizzes, your score will improve.'
    }, {
      name: 'Debt Awareness',
      emoji: '💀',
      score: debt,
      tip: 'Complete debt modules to 100%.'
    }, {
      name: 'Investment Knowledge',
      emoji: '📈',
      score: investment,
      tip: 'Earn coins by completing activities.'
    }, {
      name: 'Financial Discipline',
      emoji: '🔥',
      score: discipline,
      tip: 'Daily login — grow your streak!'
    }];
  ...
  const remark = useMemo(() => {
    if (avgScore >= 90) return 'Outstanding! You are a true Financial Scholar. Keep it up!';
    if (avgScore >= 75) return 'Great job! A little more practice and you\'ll be at the top.';
    if (avgScore >= 60) return 'Going well. Focus more on modules and quizzes.';
    if (avgScore >= 50) return 'You\'re putting in the effort. Maintain your daily streak and you\'ll see the difference!';
    return 'It\'s just the beginning. Complete modules one by one, your score will improve on its own!';
  }, [avgScore]);
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        ...
        children: "The school report card of your financial journey"
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: [['top-2 left-2', 'top-2 right-2', 'bottom-2 left-2', 'bottom-2 right-2'].map(p => /*#__PURE__*/_jsx("div", {
        ...
        children: [/*#__PURE__*/_jsx("div", {
          ...
          children: "Financial Academy"
        }), /*#__PURE__*/_jsx("p", {
          className: "text-xs text-zinc-500 italic mt-1",
          children: "\"Learn, Save, Grow\" \u2014 Est. 2024"
        ...
        children: [/*#__PURE__*/_jsx(Award, {
          ...
          children: "Distinction Holder! You're in the top 10% of students!"
        })]
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs(motion.button, {
        ...
        children: "You get +5 coins for sharing \uD83E\uDE99"
      })]
    })]
  });
}
