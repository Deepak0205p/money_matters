...
function getDirection(percentage) {
  if (percentage === 0) return {
    label: 'You haven\'t started yet!',
    emoji: '🧭',
    color: '#ef4444'
  };
  if (percentage < 25) return {
    label: 'Get out of the Debt Trap!',
    emoji: '⚠️',
    color: '#ef4444'
  };
  if (percentage < 50) return {
    label: 'You\'re on the right path!',
    emoji: '🚶',
    color: '#f59e0b'
  };
  if (percentage < 75) return {
    label: 'Great progress happening!',
    emoji: '🏃',
    color: '#f59e0b'
  };
  if (percentage < 100) return {
    label: 'Freedom is close!',
    emoji: '🚀',
    color: '#22c55e'
  };
  return {
    label: 'Financial Freedom achieved! 🎉',
    emoji: '🏆',
    color: '#22c55e'
  };
}
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs(motion.div, {
        ...
        children: "Where is your financial health? Look at the road map and understand!"
      })]
          ...
          children: /*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsx("p", {
                ...
                children: completionPercentage === 0 ? 'Complete the first module and start your journey!' : completionPercentage < 50 ? 'Complete more modules and the GPS will update!' : completionPercentage < 100 ? 'Great job! Freedom is getting closer!' : 'Congratulations! You\'ve achieved financial freedom!'
              })]
            })]
          })
        })
