...
const QUESTIONS = [{
  id: 1,
  q: 'What % of your monthly income do you save?',
  emoji: '💰',
  options: [{
    label: '0-10%',
    sub: 'Don\'t save at all',
    value: 'left',
    emoji: '💸'
  }, {
    label: '20%+',
    sub: 'I\'m a smart saver',
    value: 'right',
    emoji: '🎯'
  }]
}, {
  id: 2,
  q: 'When do you pay your credit card bill?',
  emoji: '💳',
  options: [{
    label: 'Minimum due',
    sub: 'Rest rolls over',
    ...
    label: 'Full payment',
    sub: 'On time, fully, no interest',
    value: 'right',
    emoji: '😎'
  }]
}, {
  id: 3,
  q: 'What emergency fund do you have?',
  emoji: '🛟',
  options: [{
    label: 'What\'s that?',
    sub: 'No idea',
  ...
  emoji: '📈',
  options: [{
    label: 'Just savings account',
    sub: 'That\'s enough too',
    value: 'left',
    emoji: '😴'
  }, {
    label: 'SIP / Mutual funds',
    sub: 'Wealth grows over time',
    value: 'right',
    emoji: '🌱'
  }]
}, {
  id: 5,
  q: 'How do you buy big items like an iPhone?',
  emoji: '📱',
  options: [{
    label: 'EMI works for me',
    sub: 'No tension, monthly pay',
    value: 'left',
    emoji: '📱'
  }, {
    label: 'Save first, then buy',
  ...
  id: 6,
  q: 'Do you make a monthly budget?',
  emoji: '📊',
  options: [{
    label: 'What\'s a budget?',
    sub: 'Spend whatever comes',
    value: 'left',
    emoji: '🎲'
  }, {
    label: 'Yes, by categories',
  ...
  id: 7,
  q: 'How many active loans do you have?',
  emoji: '🏦',
  options: [{
    ...
    label: 'Completely debt-free',
    sub: 'Or just a home loan',
    value: 'right',
    emoji: '🕊️'
  }]
}];
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsx(Navigation, {
          ...
          children: "Money's GPS"
        })]
      }), /*#__PURE__*/_jsx("p", {
        className: "text-sm text-ink-muted font-medium",
        children: "Financial Health Navigator \u2014 7 questions, choose your own path!"
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs("svg", {
        ...
        children: [/*#__PURE__*/_jsxs("span", {
          ...
          children: ["Question ", Math.min(currentQ + 1, QUESTIONS.length), "/", QUESTIONS.length]
        }), /*#__PURE__*/_jsx("div", {
      ...
      children: phase === 'quiz' ? /*#__PURE__*/_jsxs(motion.div, {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: "\uD83D\uDCA1 Choose the right answer \u2014 your car will head toward the right city!"
        })]
        ...
        children: [/*#__PURE__*/_jsx(motion.div, {
          ...
          children: chosenPath === 'right' ? `Congratulations ${userName || 'friend'}! Your car is on the right track. Check your score — and get stronger!` : `Don't worry ${userName || 'friend'}, you can still improve. The first step is this — check your money's GPS!`
        }), /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("p", {
              ...
              children: ["Correct answers: ", rightCount, "/", QUESTIONS.length]
            })]
          }), /*#__PURE__*/_jsxs("div", {
            className: "glass rounded-xl p-3",
            children: [/*#__PURE__*/_jsx("p", {
              ...
              className: "text-[10px] text-ink-muted",
              children: "If you start being smart now"
            })]
          })]
        }), /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx(Flag, {
            ...
            children: chosenPath === 'right' ? 'Increase your SIP and it will take 5 years less! 🚀' : 'First task: zero out credit card debt, then start SIP. 💪'
          })]
