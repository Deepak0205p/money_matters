          ...
          >
            <div className="glass-strong rounded-2xl mt-2 p-4 space-y-3 shadow-premium border-b-4 border-emerald-500/10">
              ...
              <Link href="/home/dashboard" onClick={() => setIsMenuOpen(false)} className="block">
                <div className="flex items-center gap-3 rounded-xl bg-emerald-500/15 border border-emerald-500/25 p-3 cursor-pointer hover:bg-emerald-500/20 transition-colors">
                  <User size={16} className="text-emerald-400" />
                  <span className="font-semibold text-emerald-400 text-sm flex-1">
                    Open Dashboard
                  </span>
