...
const QUICK_QUESTIONS = ['How to start a SIP?', 'How much emergency fund should I have?', 'Is a credit card good or not?', 'Where should I invest first?', 'How to make a budget?'];
const TYPING_DOTS = [{
  id: 1,
  delay: 0
}, {
...
export function FinanceAdvisor() {
  ...
  const sendMessage = useCallback(async message => {
    ...
    try {
      ...
      const errorMsg = {
        role: 'assistant',
        content: 'Oops, connection issue! 🙏 Try again in a moment — check your internet connection!',
        timestamp: Date.now()
      };
      addAdvisorMessage(errorMsg);
    } finally {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [!hasMessages && /*#__PURE__*/_jsxs(motion.div, {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: ["I am ", /*#__PURE__*/_jsx("span", {
                className: "text-amber-400 font-semibold",
                children: "Money Matters"
              }), " — your personal finance advisor!", /*#__PURE__*/_jsx("br", {}), "Ask me anything about money!"]
            }), /*#__PURE__*/_jsxs("div", {
              className: "space-y-2",
