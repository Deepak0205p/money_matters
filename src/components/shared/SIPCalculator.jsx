...
export default function SIPCalculator({ open, onClose }) {
  ...
  const handleClaimBonus = () => {
    ...
    toast({
      ...
      description: "Congratulations for understanding the power of compounding!"
    });
  };
      ...
      >
        ...
        <div className="shrink-0 px-6 py-4 border-b border-white/[0.06] bg-[#0C1021]/80 backdrop-blur-md flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-black text-white">Compounding Treasury 💰</h2>
            ...
            <div className="bg-red-500/5 border border-red-500/15 rounded-3xl p-5 flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  If you had kept this amount in a regular FD (@6.5%), the total return value would be only <strong className="text-zinc-200">{formatCurrency(fdValue)}</strong>. 
                  With SIP, you are getting <strong className="text-amber-400">{formatCurrency(totalReturns - fdReturns)}</strong> extra returns thanks to the Power of Compounding!
                </p>
              </div>
            </div>
