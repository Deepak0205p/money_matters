...
export function ShareProgress({
  ...
  const handleCopy = useCallback(async () => {
    const text = `🏆 Money Matters — My Financial Journey
...
#MoneyMatters #FinancialLiteracy #SmartMoney`;
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      ctx.fillText('My Financial Journey', width / 2, 72);
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [/*#__PURE__*/_jsx("h2", {
                ...
                children: "Share Your Progress"
              }), /*#__PURE__*/_jsx("p", {
                className: "text-[10px] text-[#8888a0]",
                children: "Show the world how far you've come!"
              })]
            })]
