...
const CHALLENGE_LIBRARY = [
  {
    ...
    rewardCoins: 100,
    color: '#EF4444',
    description: 'No junk food orders from Swiggy/Zomato for 7 days. Simple homemade food is best!'
  },
  {
    id: 'chai',
    title: 'Tea to Savings Challenge ☕💰',
    emoji: '☕💰',
    duration: 14,
    dailyGoal: 30,
    difficulty: 'Easy',
    ...
    rewardCoins: 80,
    color: '#92400E',
    description: 'Make tea at home instead of buying from the stall. Daily ₹30 savings = ₹420 saved in 2 weeks!'
  },
  {
    id: '500-week',
    ...
    rewardCoins: 120,
    color: '#F59E0B',
    description: 'Save ~₹72 daily — ₹500 in 7 days! Boost your pocket balance.'
  },
  {
    id: 'round-up',
    ...
    rewardCoins: 90,
    color: '#10B981',
    description: 'Round up every expense and register it in your savings reserve. Small change, big wealth!'
  },
  {
    id: 'no-impulse',
    ...
    rewardCoins: 150,
    color: '#EC4899',
    description: 'Strict NO on e-commerce browsing for 7 days. Only essential items allowed!'
  }
];
      ...
      >
        ...
        <div className="shrink-0 px-6 py-4 border-b border-white/[0.06] bg-[#0C1021]/80 backdrop-blur-md flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-black text-white">Savings Challenge 🐷</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
                ...
                >
                  {todayDone ? <CheckCircle2 size={14} /> : <Flame size={14} />}
                   {todayDone ? 'Today checked-in ✓' : 'Today\'s Target Saved! (+10 Coins)'}
                </button>
            ...
            <div className="bg-[#0B0E19] border border-white/[0.04] rounded-3xl p-5 text-center py-10 space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-400 max-w-sm mx-auto leading-relaxed">
                  Challenge your money discipline. Accept a preset from the list below and start a daily verification streak log.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            {trophies.length === 0 ? (
              <div className="text-center py-8 text-zinc-500 text-xs bg-[#05070F] border border-white/[0.03] rounded-3xl">
                🏆 No challenges completed yet. Accept now and earn trophy shields!
              </div>
            ) : (
        ...
        <div className="shrink-0 px-6 py-4 border-t border-white/[0.06] bg-[#0C1021]/80 backdrop-blur-md flex items-center justify-center">
          <p className="text-[9px] text-zinc-500 font-black uppercase tracking-widest">
            Savings Challenge — streaks reset on skipped check-ins
          </p>
        </div>
      </motion.div>
    </div>
