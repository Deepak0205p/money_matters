      ...
      >
        ...
        <div className="shrink-0 px-6 py-4 border-b border-white/[0.06] bg-[#0C1021]/80 backdrop-blur-md flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-black text-white">Brain Workout 🧩</h2>
            ...
            {stage === 'setup' && (
              ...
              >
                <div className="space-y-2">
                  ...
                  <h3 className="text-xl font-black text-white">Choose Your Difficulty!</h3>
                  <p className="text-xs text-zinc-400 max-w-sm mx-auto leading-relaxed">
                    Match acronyms and term pairs. Solve the puzzle in the fewest moves to earn top rewards.
                  </p>
                </div>
