...
import { EvolutionTimeline, UpiGrowthChart, FiveFunctionsOfMoney, InflationErosion, ComparisonSplit, BudgetPieChart, ThreeQuestionFlowchart, PayYourselfFirst, CoinFlip } from './Module1Animations';
...
export function SwipeCardViewer({
  ...
  return /*#__PURE__*/_jsxs("main", {
    className: "min-h-screen w-full overflow-hidden bg-slate-50 relative",
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      className: "relative z-10 w-full h-screen sm:max-w-[480px] sm:mx-auto sm:h-[94vh] sm:mt-[3vh] sm:rounded-3xl sm:border sm:border-slate-200 sm:overflow-hidden sm:shadow-2xl sm:shadow-slate-300/50 flex flex-col bg-white",
      children: [/*#__PURE__*/_jsxs("div", {
        className: "relative z-30 flex items-center justify-between px-4 pt-3 pb-1 flex-shrink-0 bg-white",
        children: [/*#__PURE__*/_jsx("button", {
          onClick: onClose,
          className: "w-8 h-8 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-slate-100 text-slate-900/70 transition-colors active:scale-90 cursor-pointer",
          "aria-label": "Close",
          ...
          children: [/*#__PURE__*/_jsx("p", {
            className: "text-[11px] font-extrabold tracking-widest uppercase truncate text-slate-900",
            style: {
          ...
          children: [/*#__PURE__*/_jsx("button", {
            ...
            className: `w-8 h-8 rounded-full border flex items-center justify-center transition-colors active:scale-90 cursor-pointer ${bookmarked ? 'bg-gold/20 border-gold/50 text-gold-soft' : 'bg-slate-50 border-slate-200 hover:bg-slate-100 text-slate-900/70'}`,
            "aria-label": "Bookmark",
            ...
            className: "w-8 h-8 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-slate-100 text-slate-900/70 transition-colors active:scale-90 cursor-pointer relative",
            "aria-label": "Notes",
        ...
        children: [/*#__PURE__*/_jsx(AnimatePresence, {
          ...
          children: /*#__PURE__*/_jsxs(motion.div, {
            className: "absolute inset-0 flex flex-col bg-white select-none overflow-hidden",
            ...
            children: [/*#__PURE__*/_jsx(RainbowProgress, {
              ...
              /*#__PURE__*/_jsxs("div", {
                className: "flex-1 flex flex-col items-center justify-between p-6 text-center relative overflow-hidden bg-white select-none",
                children: [
                  /*#__PURE__*/_jsx(motion.div, {
                          ...
                          children: [
                            /*#__PURE__*/_jsx("div", {
                              ...
                              children: /*#__PURE__*/_jsx("div", {
                                ...
                                children: /*#__PURE__*/_jsx("span", {
                                  className: "text-slate-900 text-7xl font-black drop-shadow-[0_4px_8px_rgba(0,0,0,0.4)] select-none",
                                  children: "₹"
                                })
                              })
                            }),
                            /*#__PURE__*/_jsx("div", {
                              ...
                              children: /*#__PURE__*/_jsx("div", {
                                ...
                                children: /*#__PURE__*/_jsx("span", {
                                  className: "text-slate-900 text-6xl font-black drop-shadow-[0_4px_8px_rgba(0,0,0,0.4)] select-none",
                                  children: "🪙"
                                })
                              })
                            }),
                  ...
                  /*#__PURE__*/_jsxs("div", {
                    className: "relative z-10 flex items-center gap-2 px-4 py-2.5 rounded-full bg-slate-50 border border-slate-200 shadow-lg mb-8",
                    children: [
                      /*#__PURE__*/_jsxs("svg", {
                        width: "14",
                        height: "14",
                      ...
                      /*#__PURE__*/_jsx("span", {
                        className: "text-[9px] text-slate-500 font-extrabold tracking-wider uppercase select-none",
              ...
              /*#__PURE__*/_jsxs("div", {
                ...
                children: [!currentCard.hideHeader && /*#__PURE__*/_jsxs("div", {
                  className: "relative rounded-2xl overflow-hidden border border-slate-200 shadow-lg flex flex-col justify-end p-6 bg-white",
                  style: {
                    height: '32%',
                    minHeight: '180px'
                  },
                  children: [/*#__PURE__*/_jsx(motion.div, {
                    ...
                    children: [/*#__PURE__*/_jsx("span", {
                      ...
                      className: "font-extrabold text-[17px] sm:text-[19px] tracking-tight leading-snug text-slate-800",
                      initial: {
                        opacity: 0,
                        y: 15
                      },
                  ...
                  children: currentCard.id === '1-1-2' ? (
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "font-mono text-slate-700 text-[15px] sm:text-[16px] leading-relaxed space-y-5 pt-4 px-2 select-none",
                      children: [
                        ...
                        /*#__PURE__*/_jsxs(motion.p, {
                          ...
                          children: [
                            ...
                            " or ",
                            /*#__PURE__*/_jsx("span", { className: "text-slate-500 font-extrabold", children: "metal" }),
                            " — it is a ",
                        ...
                        /*#__PURE__*/_jsx(motion.p, {
                          ...
                          className: "text-slate-400 text-xs italic font-semibold tracking-wide",
                    ...
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "font-mono text-slate-700 text-[15px] sm:text-[16px] leading-relaxed space-y-4 pt-2 px-1 select-none",
                      children: [
                        /*#__PURE__*/_jsxs(motion.p, {
                          initial: { x: -15, opacity: 0 },
                          animate: { x: 0, opacity: 1 },
                    ...
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "font-mono text-slate-700 text-[15px] sm:text-[16px] leading-relaxed space-y-3 pt-2 px-1 select-none",
                      children: [
                        /*#__PURE__*/_jsx(motion.p, {
                          initial: { x: -15, opacity: 0 },
                          animate: { x: 0, opacity: 1 },
                    ...
                    /*#__PURE__*/_jsxs(motion.div, {
                      ...
                      children: [
                        /*#__PURE__*/_jsx(CoinFlip, { color: currentCard.color }),
                        /*#__PURE__*/_jsx(EvolutionTimeline, { color: currentCard.color })
                      ]
                    })
                  ) : currentCard.id === '1-1-2' ? (
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "space-y-2 pt-1",
                      children: [
                        /*#__PURE__*/_jsx(UpiGrowthChart, { color: currentCard.color }),
                        /*#__PURE__*/_jsxs("p", {
                          className: "text-xs text-slate-500 text-center px-2",
                          children: [
                            "Neobanks like ",
                            /*#__PURE__*/_jsx("span", { className: "text-blue-500 font-bold", children: "Jupiter" }),
                            ", ",
                            /*#__PURE__*/_jsx("span", { className: "text-purple-500 font-bold", children: "Fi" }),
                            ", and ",
                            /*#__PURE__*/_jsx("span", { className: "text-emerald-500 font-bold", children: "Niyo" }),
                            " offer completely digital banking."
                          ]
                        })
                      ]
                    })
                    ...
                    /*#__PURE__*/_jsx(motion.div, {
                      ...
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(FiveFunctionsOfMoney, { color: currentCard.color })
                    })
                  ) : currentCard.id === '1-1-4' ? (
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      ...
                      className: "space-y-2 pt-1",
                      children: [
                        /*#__PURE__*/_jsx(InflationErosion, { color: currentCard.color }),
                        /*#__PURE__*/_jsxs("p", {
                          className: "text-xs text-slate-600 text-center px-3 italic",
                          children: [
                            "Money is not just a number — it's ",
                            /*#__PURE__*/_jsx("span", { className: "text-red-500 font-bold", children: "purchasing power" }),
                            "."
                          ]
                        })
                      ]
                    ...
                    /*#__PURE__*/_jsx(motion.div, {
                      ...
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(ComparisonSplit, {
                        left: { title: 'Active Income', items: ['Work → Get paid', 'Stop work → Income stops', 'Salary, Tuition, Freelance'] },
                        right: { title: 'Passive Income', items: ['Effort once → Earn repeatedly', 'Works while you sleep', 'YouTube, SIP, Digital products'] },
                        leftColor: '#EF4444',
                        rightColor: '#10B981'
                      })
                    })
                    ...
                    /*#__PURE__*/_jsx(motion.div, {
                      ...
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(ComparisonSplit, {
                        left: { title: 'Fixed (Unavoidable)', items: ['Rent: ₹3k-8k', 'Mess: ₹2.5k-4k', 'Phone: ₹199-599', 'Transport: ₹500-2k'] },
                        right: { title: 'Variable (Controllable)', items: ['Swiggy: ₹1k-5k', 'Shopping: ₹500-3k', 'Entertainment: ₹200-2k', 'Chai: ₹300-1.5k'] },
                        leftColor: '#EF4444',
                        rightColor: '#F59E0B'
                      })
                    })
                    ...
                    /*#__PURE__*/_jsx(motion.div, {
                      ...
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(ThreeQuestionFlowchart, { color: currentCard.color })
                    })
                  ) : currentCard.id === '1-1-11' ? (
                    /*#__PURE__*/_jsx(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(PayYourselfFirst, { color: currentCard.color })
                    })
                  ) : currentCard.id === '1-1-12' ? (
                    /*#__PURE__*/_jsx(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(BudgetPieChart, { color: currentCard.color })
                    })
                  ) : currentCard.id === '2-1-1' ? (
                    /*#__PURE__*/_jsx(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "pt-1",
                  ...
                  ) : currentCard.id === '2-1-7' ? (
                    /*#__PURE__*/_jsx(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "pt-1",
                      children: /*#__PURE__*/_jsx(ComparisonSplit, {
                        left: { title: 'NEEDS', items: ['Tuition fees', 'Internet recharge', 'Doctor visit', 'Public transport', 'Health insurance', 'Mess food'] },
                        right: { title: 'WANTS', items: ['Branded backpack', 'Netflix subscription', 'Gaming laptop', 'Daily Starbucks', 'iPhone 15', 'iPad for notes'] },
                        leftColor: '#10B981',
                        rightColor: '#F59E0B'
                      })
                    })
                  ) : currentCard.id === '2-1-8' ? (
                    /*#__PURE__*/_jsx(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "pt-1",
                  ...
                  ) : currentCard.id === '2-1-12' ? (
                    /*#__PURE__*/_jsxs(motion.div, {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      className: "space-y-3 pt-1",
                      children: [
                        /*#__PURE__*/_jsx(UpiGrowthChart, { color: '#F59E0B' }),
                        /*#__PURE__*/_jsxs("div", {
                          className: "bg-amber-50 border border-amber-200 rounded-xl p-3",
                          children: [
                            /*#__PURE__*/_jsx("p", {
                              className: "text-xs font-bold text-amber-700 mb-1",
                              children: "Buffer Month System"
                            }),
                            /*#__PURE__*/_jsx("p", {
                              className: "text-[10px] text-amber-600",
                              children: "Save 50% of extra from good months. When bad month comes, manage from buffer."
                            })
                          ]
                        })
                      ]
              ...
              /*#__PURE__*/_jsx("div", {
                ...
                children: /*#__PURE__*/_jsxs(motion.div, {
                  ...
                  children: [/*#__PURE__*/_jsx(ArrowUp, {
                    size: 14,
                    className: "text-slate-900/35"
                  }), /*#__PURE__*/_jsx("span", {
                    className: "text-slate-900/35 text-[10px] font-medium tracking-wider uppercase",
                    children: "Swipe Up"
                  })]
                })
              })
          ...
          children: showNotes && /*#__PURE__*/_jsxs(motion.div, {
            ...
            className: "absolute inset-x-0 bottom-0 top-1/4 z-50 rounded-t-3xl bg-white border-t border-slate-200 shadow-[0_-20px_60px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden",
            children: [/*#__PURE__*/_jsxs("div", {
              className: "flex items-center justify-between p-4 border-b border-slate-200 bg-white",
              children: [/*#__PURE__*/_jsxs("h3", {
                ...
                className: "p-2 rounded-full hover:bg-slate-100 text-slate-900/60",
              ...
              children: notes.length === 0 ? /*#__PURE__*/_jsx("div", {
                className: "text-center text-slate-900/40 mt-10 text-sm",
                children: "No notes yet. Add one below!"
              }) : notes.map((n, i) => /*#__PURE__*/_jsxs("div", {
                className: "group relative bg-slate-50 border border-slate-200 rounded-xl p-3 text-sm text-slate-900/80 pr-10",
              ...
              children: /*#__PURE__*/_jsxs("div", {
                ...
                children: [/*#__PURE__*/_jsx("input", {
                  ...
                  className: "flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm text-slate-900 outline-none focus:border-gold/50 focus:bg-slate-100 transition-colors"
                }), /*#__PURE__*/_jsx("button", {
                  onClick: addNote,
                  disabled: !newNote.trim(),
                  className: "w-10 h-10 flex-shrink-0 flex items-center justify-center bg-gold text-black rounded-xl disabled:opacity-50 disabled:bg-slate-200 disabled:text-slate-900/40",
                  "aria-label": "Add note",
...
function InteractiveValueExchange({ color }) {
  ...
  return _jsxs("div", {
    className: "mt-6 p-5 rounded-2xl bg-slate-100 border border-slate-200 space-y-4 flex flex-col items-center",
    children: [
      _jsx("h4", {
      ...
      _jsxs("div", {
        className: "relative w-full h-32 bg-slate-100 rounded-xl overflow-hidden border border-slate-200 flex items-center justify-between px-6",
        style: { perspective: 1000 },
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("span", {
                className: "text-[10px] text-slate-500 font-bold mt-1",
                children: "You"
              })
            ]
          }),
          _jsxs("div", {
            className: "absolute inset-x-16 h-1 bg-slate-50 rounded-full flex items-center justify-center",
            children: [
        ...
        children: [
          ...
          _jsx("div", {
            ...
            children: Object.entries(items).map(([key, item]) => _jsx("button", {
              ...
              className: "p-2.5 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 transition-colors active:scale-95 cursor-pointer",
              children: item.label
            }, key))
          })
        ]
      ...
      exchangeState === 'paying' && _jsx("div", {
        className: "text-[12px] text-slate-500 animate-pulse font-medium",
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("p", {
                className: "text-[11px] text-slate-600 mt-1.5 leading-relaxed",
                children: [
          ...
          _jsx("button", {
            onClick: handleReset,
            className: "px-4 py-1.5 bg-slate-100 hover:bg-slate-100 rounded-lg text-[11px] font-bold text-slate-900 transition-colors active:scale-95 cursor-pointer",
...
function InteractiveBarterDilemma({ color }) {
  ...
  return _jsxs("div", {
    className: "mt-4 p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-4 flex flex-col items-center select-none font-mono",
    children: [
      _jsx("h4", {
      ...
      _jsxs("div", {
        className: "relative w-full h-40 bg-slate-200 rounded-xl overflow-hidden border border-slate-200 flex flex-col justify-between p-3",
        children: [
          _jsxs("div", {
          ...
          _jsx("div", {
            className: "w-full h-8 relative bg-slate-50 border border-slate-200 rounded-lg overflow-hidden flex items-center justify-center",
            children: step === 'problem' ? _jsx("button", {
              onClick: () => setStep('fail'),
              className: "text-[10px] bg-slate-100 hover:bg-slate-100 px-3 py-1 rounded-md font-bold text-slate-900 transition-colors active:scale-95 cursor-pointer",
              ...
              children: [_jsx("span", {
                ...
                className: "text-[9px] bg-slate-100 hover:bg-slate-200 px-2 py-0.5 rounded font-bold text-slate-900 transition-colors active:scale-95 cursor-pointer",
                children: "Restart"
              })]
            })
          })
...
function InteractiveEvolutionFlowchart({ color }) {
  ...
  return _jsxs("div", {
    className: "mt-4 p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-4 font-mono select-none",
    children: [_jsx("h4", {
      className: "text-[11px] font-black uppercase tracking-wider text-slate-500 text-center",
      ...
      children: steps.map((s, idx) => _jsxs("div", {
        ...
        children: [_jsxs("button", {
          ...
          className: `flex flex-col items-center justify-center p-2 rounded-xl border transition-all duration-300 w-16 h-16 ${activeIndex === idx ? 'bg-amber-400/20 border-amber-400 shadow-[0_0_12px_rgba(251,191,36,0.3)]' : 'bg-slate-50 border-slate-200 opacity-60 hover:opacity-100'}`,
          children: [_jsx("span", {
            className: "text-lg",
            children: s.icon
          }), _jsx("span", {
            className: "text-[8px] font-bold mt-1 text-center truncate w-full text-slate-600",
            children: s.title.split(' ')[0]
          })]
        }), idx < steps.length - 1 && _jsx("span", {
          className: "text-slate-400 text-xs px-0.5",
          children: "➔"
        })]
      }, idx))
      ...
      children: _jsxs(motion.div, {
        ...
        className: "p-3 rounded-xl bg-slate-100 border border-slate-200 space-y-2",
        children: [_jsxs("div", {
          className: "flex items-center space-x-2 border-b border-slate-200 pb-1.5",
          children: [_jsx("span", {
            className: "text-lg",
  ...
  return _jsxs("div", {
    ...
    children: [_jsx("h4", {
      ...
      children: steps.map((s, idx) => _jsx("button", {
        ...
        className: `z-10 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all ${activeStep === idx ? 'bg-amber-400 text-black shadow-[0_0_12px_rgba(251,191,36,0.5)] scale-110' : 'bg-slate-50 border border-slate-200 text-slate-500 hover:text-slate-900'}`,
        children: idx + 1
      }, idx))
    }), _jsx(AnimatePresence, {
      mode: "wait",
      children: _jsxs(motion.div, {
        ...
        className: "p-3.5 rounded-xl bg-slate-100 border border-slate-200 space-y-2.5",
        children: [_jsxs("div", {
          className: "flex justify-between items-center border-b border-slate-200 pb-1.5",
          children: [_jsx("span", {
            className: "text-xs font-bold text-amber-400",
            children: steps[activeStep].title
          }), _jsx("span", {
            className: "text-[8px] px-2 py-0.5 rounded bg-slate-100 text-slate-500",
...
function InteractiveFiveFunctions({ color }) {
  ...
  return _jsxs("div", {
    ...
    children: [_jsx("h4", {
      ...
      className: "flex space-x-1.5 overflow-x-auto py-1 scrollbar-none border-b border-slate-200 pb-2",
      children: Object.entries(tabs).map(([key, tab]) => _jsx("button", {
        ...
        className: `px-2.5 py-1.5 rounded-lg text-[9px] font-bold transition-all flex-shrink-0 cursor-pointer ${activeTab === key ? 'bg-amber-400 text-black font-extrabold shadow-[0_2px_8px_rgba(251,191,36,0.3)]' : 'bg-slate-50 border border-slate-200 text-slate-500 hover:text-slate-900'}`,
        children: tab.title
      }, key))
    }), _jsxs("div", {
      className: "p-3 rounded-xl bg-slate-100 border border-slate-200 space-y-3",
      children: [_jsx("p", {
        className: "text-[11px] text-slate-600 leading-relaxed",
        ...
        children: [_jsx("h5", {
          ...
          className: "flex justify-between items-center bg-slate-100 p-2.5 rounded-lg border border-slate-200",
          children: [_jsxs("div", {
          ...
          className: "space-y-2 text-[10px] text-slate-600",
          children: [_jsxs("div", {
            className: "flex justify-between bg-slate-100 p-1.5 rounded border border-slate-200",
            children: [_jsx("span", {
          ...
          children: [_jsxs("div", {
            ...
            children: [_jsx("button", {
              ...
              className: `px-2 py-1 rounded text-[9px] font-bold cursor-pointer ${savingsType === 'money' ? 'bg-amber-400 text-black' : 'bg-slate-50 border border-slate-200 text-slate-600'}`,
              children: "Save ₹1,000 🪙"
            }), _jsx("button", {
              onClick: () => {
              ...
              className: `px-2 py-1 rounded text-[9px] font-bold cursor-pointer ${savingsType === 'tomatoes' ? 'bg-amber-400 text-black' : 'bg-slate-50 border border-slate-200 text-slate-600'}`,
              children: "Save Tomatoes 🍅"
            })]
          }), _jsxs("div", {
            className: "bg-slate-100 p-2.5 rounded border border-slate-200 flex items-center justify-between text-[10px]",
            children: [_jsxs("div", {
              children: [_jsxs("span", {
          ...
          className: "space-y-2 text-[10px] text-slate-600",
          children: [_jsxs("div", {
            className: "flex justify-between items-center bg-slate-100 p-2 rounded border border-slate-200",
            children: [_jsx("span", {
          ...
          className: "relative w-full h-16 bg-slate-100 rounded-lg border border-slate-200 flex items-center justify-between px-6 overflow-hidden",
          children: [upiStatus === 'idle' && _jsx("button", {
            ...
            children: [_jsx("span", {
              ...
              className: "w-4 h-4 rounded-full bg-emerald-500 flex items-center justify-center text-[9px] font-bold text-slate-900 shadow-[0_0_8px_#10B981]",
              children: "₹"
            }), _jsx("span", {
              className: "text-[9px] text-slate-500",
              children: "Mumbai 📍"
            ...
            children: [_jsx("span", {
              ...
              className: "text-[8px] bg-slate-100 px-2 py-0.5 rounded text-slate-900",
              children: "Send again"
            })]
          })]
        })]
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("input", {
            ...
            className: "flex-1 bg-slate-200 border border-slate-200 rounded-xl px-3 py-1.5 text-xs sm:text-sm text-slate-900 outline-none focus:border-emerald-500/50"
          }),
          _jsx("select", {
            value: filter,
            onChange: e => setFilter(e.target.value),
            className: "bg-slate-200 border border-slate-200 rounded-xl px-2 py-1.5 text-xs sm:text-sm text-slate-600 outline-none",
            children: [
      ...
      _jsx("div", {
        ...
        children: filtered.map(s => _jsxs("div", {
          ...
          className: `p-2.5 rounded-xl border transition-all cursor-pointer ${selectedSource === s.id ? 'bg-emerald-500/10 border-emerald-500/40' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'}`,
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", { className: "text-xs sm:text-sm font-bold text-slate-800", children: s.title })
                  ]
                }),
            ...
            selectedSource === s.id && _jsx(motion.div, {
              ...
              className: "mt-2 pt-2 border-t border-slate-200 text-xs sm:text-sm text-slate-500 leading-relaxed",
              children: s.desc
            })
          ]
        }, s.id))
    ...
    children: [
      _jsx("div", {
        ...
        children: Object.keys(content).map(key => _jsx("button", {
          ...
          className: `py-1.5 px-1 rounded-lg text-[11px] sm:text-xs font-bold transition-all uppercase ${activeType === key ? 'bg-emerald-500 text-black shadow-lg shadow-emerald-500/20' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
          children: key
        }, key))
      }),
      _jsxs("div", {
        className: "p-4 rounded-xl bg-slate-100 border border-slate-200 flex items-center gap-4",
        children: [
          _jsx("div", {
            className: "flex-shrink-0 flex items-center justify-center bg-slate-50 p-2 rounded-xl border border-slate-200",
            children: content[activeType].svg
          }),
          _jsxs("div", {
            className: "flex-1 space-y-1",
            children: [
              _jsx("h4", { className: "text-sm sm:text-base font-black text-slate-900 leading-tight", children: content[activeType].title }),
              _jsx("h5", { className: "text-[11px] sm:text-xs font-bold text-emerald-400", children: content[activeType].sub }),
              _jsx("p", { className: "text-[11px] sm:text-xs text-slate-500 leading-relaxed", children: content[activeType].desc })
            ]
          })
        ]
      }),
      _jsxs("div", {
        ...
        children: [
          _jsx("h5", { className: "text-[11px] sm:text-xs font-bold text-slate-500 uppercase tracking-wide", children: "Typical Scenarios / Best Practices:" }),
          _jsx("div", {
            className: "grid grid-cols-1 gap-1.5",
            children: content[activeType].examples.map((ex, i) => _jsxs("div", {
              className: "flex items-center space-x-2 bg-slate-50 px-2.5 py-1.5 rounded-lg border border-slate-200 text-xs sm:text-sm text-slate-600",
              children: [
...
function InteractiveExpenseConcept({ color }) {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h4", {
        className: "text-xs sm:text-sm font-black uppercase tracking-wider text-slate-500 text-center",
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className: "p-3 rounded-xl bg-slate-100 border border-slate-200 space-y-3",
            children: [
              _jsx("h5", { className: "text-xs sm:text-sm font-extrabold text-sky-400 uppercase border-b border-slate-200 pb-1", children: "Fixed (Needs)" }),
              _jsxs("div", {
                className: "space-y-2 text-xs sm:text-sm text-slate-600",
                children: [
                  _jsxs("div", {
                    children: [
                      _jsxs("span", { className: "flex justify-between", children: [_jsx("span", { children: "PG Rent:" }), _jsxs("span", { className: "text-slate-900", children: ["₹", rent] })] }),
                  ...
                  _jsxs("div", {
                    children: [
                      _jsxs("span", { className: "flex justify-between", children: [_jsx("span", { children: "Mess Plan:" }), _jsxs("span", { className: "text-slate-900", children: ["₹", mess] })] }),
                  ...
                  _jsxs("div", { className: "flex justify-between text-slate-400", children: [_jsx("span", { children: "Phone Recharge:" }), _jsx("span", { children: "₹399" })] }),
                  _jsxs("div", { className: "flex justify-between text-slate-400", children: [_jsx("span", { children: "Metro Pass:" }), _jsx("span", { children: "₹500" })] }),
                  _jsxs("div", { className: "border-t border-slate-200 pt-1 flex justify-between font-black text-sky-400 text-xs sm:text-sm", children: [_jsx("span", { children: "Fixed Sum:" }), _jsxs("span", { children: ["₹", fixedTotal] })] })
                ]
              })
            ]
          }),
          _jsxs("div", {
            className: "p-3 rounded-xl bg-slate-100 border border-slate-200 space-y-3",
            children: [
              _jsx("h5", { className: "text-xs sm:text-sm font-extrabold text-red-400 uppercase border-b border-slate-200 pb-1", children: "Variable (Wants)" }),
              _jsxs("div", {
                className: "space-y-2 text-xs sm:text-sm text-slate-600",
                children: [
                  _jsxs("div", {
                    children: [
                      _jsxs("span", { className: "flex justify-between", children: [_jsx("span", { children: "Swiggy/Eating Out:" }), _jsxs("span", { className: "text-slate-900", children: ["₹", eatingOut] })] }),
                  ...
                  _jsxs("div", {
                    children: [
                      _jsxs("span", { className: "flex justify-between", children: [_jsx("span", { children: "Chai/Coffee Days:" }), _jsxs("span", { className: "text-slate-900", children: [chaiFreq, " cups"] })] }),
                  ...
                  _jsxs("div", { className: "flex justify-between text-slate-400", children: [_jsx("span", { children: "Shopping/Movies:" }), _jsx("span", { children: "₹1,000" })] }),
                  _jsxs("div", { className: "flex justify-between text-slate-400", children: [_jsx("span", { children: "Weekend Trips:" }), _jsx("span", { children: "₹500" })] }),
                  _jsxs("div", { className: "border-t border-slate-200 pt-1 flex justify-between font-black text-red-400 text-xs sm:text-sm", children: [_jsx("span", { children: "Variable Sum:" }), _jsxs("span", { children: ["₹", variableTotal] })] })
                ]
              })
            ]
          })
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            children: [
              _jsx("span", { className: "text-slate-500", children: "Total Outflow: " }),
              _jsxs("span", { className: "font-black text-slate-900", children: ["₹", fixedTotal + variableTotal] })
            ]
          }),
          _jsxs("div", {
            className: "text-xs sm:text-sm font-black text-right",
            children: [
              _jsx("span", { className: "text-slate-400 block", children: "Discretionary Ratio:" }),
              _jsxs("span", {
...
function InteractiveNeedsVsWantsSim({ color }) {
  ...
  if (isFinished) {
    return _jsxs("div", {
      className: "mt-4 p-5 rounded-2xl bg-slate-50 border border-slate-200 text-center space-y-4 font-mono select-none",
      children: [
        _jsx("div", { className: "text-4xl animate-bounce", children: "🏆" }),
        _jsx("h4", { className: "text-sm font-black text-slate-900", children: "Needs vs Wants Game Completed" }),
        _jsxs("p", { className: "text-[12px] text-slate-500", children: ["Your Score: ", score, " / ", scenarios.length] }),
        _jsx("div", {
          className: "p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-xs sm:text-sm text-slate-600 leading-relaxed",
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("span", { className: "text-[11px] sm:text-xs text-slate-400 font-extrabold uppercase", children: "Scenario Sorter" }),
          _jsxs("span", { className: "text-xs sm:text-sm text-emerald-400 font-bold", children: [index + 1, " / ", scenarios.length] })
        ]
      }),
      _jsxs("div", {
        className: "h-28 bg-slate-100 border border-slate-200 rounded-xl flex flex-col items-center justify-center p-4 relative overflow-hidden",
        children: [
          feedback ? (
            _jsxs(motion.div, {
              ...
              children: [
                ...
                _jsx("p", { className: "text-xs sm:text-sm text-slate-500 max-w-[280px] leading-tight", children: scenarios[index].desc })
              ]
            })
          ) : (
            _jsxs("div", {
              ...
              children: [
                _jsx("span", { className: "text-slate-400 text-[10px] uppercase tracking-widest", children: "Item to classify:" }),
                _jsx("h4", { className: "text-base sm:text-lg font-black text-slate-900", children: scenarios[index].item })
              ]
            })
          )]
      }),
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx("button", {
            ...
            className: "flex-1 bg-red-500 text-slate-900 py-2 rounded-xl text-sm sm:text-base font-bold transition-all disabled:opacity-50 active:scale-95 cursor-pointer",
            children: "WANT"
          })
        ]
      })
...
function InteractiveMidWayQuiz({ color }) {
  ...
  if (quizState === 'ended') {
    return _jsxs("div", {
      ...
      children: [
        ...
        _jsx("h4", { className: "text-sm font-black text-slate-900", children: "Reinforcement Quiz Completed" }),
        _jsxs("p", { className: "text-[12px] text-slate-500", children: ["Final Score: ", score, " / ", questions.length] }),
        _jsx("div", {
          className: "p-3 rounded-xl bg-purple-500/10 border border-purple-500/20 text-xs sm:text-sm text-slate-600 leading-relaxed",
        ...
        _jsx("button", {
          onClick: handleRestart,
          className: "w-full bg-purple-500 text-slate-900 py-2 rounded-xl text-sm sm:text-base font-bold transition-all active:scale-95 cursor-pointer",
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        className: "flex justify-between items-center border-b border-slate-200 pb-2 text-[11px] sm:text-xs text-slate-400 font-extrabold uppercase",
        children: [
      ...
      _jsx("div", {
        className: "min-h-[60px] flex items-center bg-slate-100 border border-slate-200 p-3 rounded-xl",
        children: _jsx("h4", { className: "text-xs sm:text-sm font-bold text-slate-800 leading-normal", children: questions[qIdx].q })
      }),
      _jsx("div", {
        className: "space-y-1.5",
      ...
      quizState === 'answered' && _jsxs("p", {
        className: "text-xs sm:text-sm text-slate-400 italic text-center",
    ...
    children: [
      _jsx("div", {
        ...
        children: [
          _jsx("button", {
            ...
            className: `flex-1 py-1.5 rounded-lg text-xs sm:text-sm font-bold transition-all uppercase ${activeTab === 'reasons' ? 'bg-pink-500 text-slate-900 font-extrabold shadow-lg shadow-pink-500/20' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
            children: "10 Reasons to Save"
          }),
          _jsx("button", {
            onClick: () => { setActiveTab('myths'); setActiveItem(null); },
            className: `flex-1 py-1.5 rounded-lg text-xs sm:text-sm font-bold transition-all uppercase ${activeTab === 'myths' ? 'bg-pink-500 text-slate-900 font-extrabold shadow-lg shadow-pink-500/20' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
            children: "10 Myths Busted"
          })
        ]
      }),
      _jsxs("div", {
        className: "relative w-full h-16 bg-slate-100 rounded-xl border border-slate-200 flex items-center justify-center p-2",
        children: [
          _jsxs("svg", {
      ...
      _jsx("div", {
        ...
        children: list.map(item => _jsxs("div", {
          ...
          className: `p-2.5 rounded-xl border transition-all cursor-pointer ${activeItem === item.id ? 'bg-pink-500/10 border-pink-500/40' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'}`,
          children: [
            _jsxs("div", {
              className: "flex justify-between items-center",
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", { className: "text-xs sm:text-sm font-bold text-slate-700", children: item.title })
                  ]
                }),
                _jsx("span", { className: "text-xs sm:text-sm text-slate-400", children: activeItem === item.id ? "▲" : "▼" })
              ]
            }),
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className: "flex justify-between text-xs sm:text-sm text-slate-600",
            children: [
      ...
      _jsxs("div", {
        className: "grid grid-cols-2 gap-4 h-36 bg-slate-100 rounded-xl p-3 border border-slate-200 relative overflow-hidden",
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("span", { className: "text-[10px] text-slate-500 block font-bold uppercase", children: "Expenses" }),
            ...
            children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("span", { className: "text-[10px] text-slate-500 block font-bold uppercase", children: "Savings" }),
      ...
      _jsx("p", {
        className: "text-[10px] sm:text-xs text-slate-500 text-center leading-relaxed",
    ...
    children: [
      ...
      _jsx("div", {
        ...
        children: scenarios.map((s) => _jsx("button", {
          ...
          className: `px-2.5 py-1.5 rounded-lg text-[9px] sm:text-xs font-bold transition-all flex-shrink-0 cursor-pointer ${activeId === s.id ? 'bg-amber-400 text-black font-extrabold shadow-md' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
          children: s.name.split(' ')[1]
        }, s.id))
      }),
      _jsxs("div", {
        className: "p-4 rounded-xl bg-slate-100 border border-slate-200 space-y-3",
        children: [
          _jsxs("div", {
            className: "flex justify-between items-center border-b border-slate-200 pb-2",
            children: [
              ...
              _jsxs("span", { className: "text-[10px] sm:text-xs text-slate-500", children: ["Income: ", current.income] })
            ]
          }),
          _jsxs("p", { className: "text-xs sm:text-sm text-slate-600 leading-relaxed", children: [_jsx("strong", { children: "Situation: " }), current.details] }),
          _jsxs("p", { className: "text-xs sm:text-sm text-slate-600 leading-relaxed", children: [_jsx("strong", { children: "Behavior: " }), current.actions] }),
          _jsxs("div", {
            className: `p-2.5 rounded-lg text-xs sm:text-sm font-bold flex justify-between items-center ${current.saved > 0 ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : current.saved < 0 ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'bg-slate-100 text-slate-500 border border-slate-300'}`,
            children: [
            ...
            children: [
              _jsxs("div", {
                children: [
                  ...
                  _jsx("span", { className: "text-[9px] sm:text-xs text-slate-500", children: "Rent, Food, Bills, Metro" })
                ]
              }),
              _jsxs("span", { className: "text-xs sm:text-sm font-black text-slate-900", children: ["₹", needs.toLocaleString()] })
            ]
          }),
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                children: [
                  ...
                  _jsx("span", { className: "text-[9px] sm:text-xs text-slate-500", children: "Movies, Swiggy, Chai Outings" })
                ]
              }),
              _jsxs("span", { className: "text-xs sm:text-sm font-black text-slate-900", children: ["₹", wants.toLocaleString()] })
            ]
          }),
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                children: [
                  ...
                  _jsx("span", { className: "text-[9px] sm:text-xs text-slate-500", children: "Emergency Fund, SIP, Stocks" })
                ]
              }),
              _jsxs("span", { className: "text-xs sm:text-sm font-black text-slate-900", children: ["₹", savings.toLocaleString()] })
            ]
          })
        ]
      })
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsx("button", {
            ...
            className: `flex-1 py-1.5 rounded-lg text-xs font-bold transition-all uppercase ${tab === 'pay_first' ? 'bg-amber-400 text-black font-extrabold shadow-md' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
            children: "Pay Yourself First"
          }),
          _jsx("button", {
            onClick: () => setTab('zbb'),
            className: `flex-1 py-1.5 rounded-lg text-xs font-bold transition-all uppercase ${tab === 'zbb' ? 'bg-amber-400 text-black font-extrabold shadow-md' : 'bg-slate-50 border border-slate-200 text-slate-500'}`,
      ...
      tab === 'pay_first' ? _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            className: "flex items-center justify-between bg-slate-100 border border-slate-200 p-3 rounded-xl",
            children: [
              _jsxs("div", {
                children: [
                  _jsx("span", { className: "text-xs sm:text-sm font-bold text-slate-900 block", children: "Automated Auto-Debit" }),
                  _jsx("span", { className: "text-[9px] sm:text-xs text-slate-500", children: "Transfer ₹1,000 to Savings first" })
                ]
              }),
              _jsx("button", {
                onClick: () => setAutoDebit(!autoDebit),
                className: `px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${autoDebit ? 'bg-emerald-500 text-black' : 'bg-slate-100 text-slate-900 hover:bg-slate-100'}`,
                children: autoDebit ? "ACTIVE ✓" : "ACTIVATE"
              })
            ]
          }),
          _jsxs("div", {
            className: "relative w-full h-32 bg-slate-200 rounded-xl border border-slate-200 flex items-center justify-around overflow-hidden px-4",
            children: [
              _jsxs("div", {
                className: "text-center",
                children: [
                  _jsx("div", { className: "text-2xl", children: "💵" }),
                  _jsx("span", { className: "text-[10px] text-slate-500 block font-bold", children: "Income Inflow" })
                ]
              }),
              _jsxs("div", {
                ...
                children: autoDebit ? [
                  ...
                  _jsx("span", { className: "text-[10px] text-slate-400 italic", children: "Waiting for auto-debit instruction..." })
                ]
              }),
              _jsxs("div", {
                className: "text-center",
                children: [
                  _jsx("div", { className: "text-2xl", children: "🏦" }),
                  _jsx("span", { className: "text-[10px] text-slate-500 block font-bold", children: "Savings Account" })
                ]
              })
            ]
          })
        ...
        children: [
          _jsxs("div", {
            className: "flex justify-between items-center border-b border-slate-200 pb-2",
            children: [
              _jsxs("span", { className: "text-xs text-slate-500", children: ["Income: ", _jsx("strong", { className: "text-slate-900", children: "₹15,000" })] }),
              _jsxs("span", {
          ...
          _jsx("div", {
            ...
            children: Object.entries(allocations).map(([cat, val]) => _jsxs("div", {
              className: "bg-slate-100 border border-slate-200 p-2 rounded-xl text-xs flex flex-col space-y-1",
              children: [
                _jsxs("span", { className: "capitalize text-slate-600 font-bold flex justify-between", children: [_jsx("span", { children: cat }), _jsxs("span", { className: "text-amber-400", children: ["₹", val] })] }),
                _jsx("input", {
                  type: "range",
                  min: "0",
...
function InteractiveLiteracyGap({ color }) {
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsxs("div", {
        className: "p-4 rounded-xl bg-slate-100 border border-slate-200 space-y-4",
        children: [
          _jsxs("div", {
            className: "space-y-1.5",
            children: [
              _jsxs("div", {
                className: "flex justify-between text-xs sm:text-sm text-slate-600 font-bold",
                children: [
    ...
    children: [
      ...
      _jsx("div", {
        ...
        children: nodes.map((node) => _jsx("button", {
          ...
          className: `p-2.5 rounded-xl border text-xs sm:text-sm font-bold text-left transition-all ${selectedNode === node.id ? 'bg-amber-400/10 border-amber-400 text-amber-400' : 'bg-slate-50 border-slate-200 text-slate-600'}`,
          children: node.title
        }, node.id))
      }),
      selectedNode && _jsx(motion.div, {
        ...
        animate: { opacity: 1, y: 0 },
        className: "p-3 rounded-xl bg-slate-100 border border-slate-200 text-xs sm:text-sm text-slate-500 leading-relaxed",
        children: nodes.find(n => n.id === selectedNode).desc
      }),
      _jsx("div", { className: "border-t border-slate-200 pt-3" }),
      _jsx("h5", { className: "text-xs sm:text-sm font-bold text-slate-500 uppercase tracking-wider text-center", children: "Roleplay: Talk with Parents" }),
      _jsxs("div", {
        className: "p-3 bg-slate-100 border border-slate-200 rounded-xl space-y-2 text-xs sm:text-sm",
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              roleplayStep < dialogue.length - 1 ? _jsx("button", {
                ...
                className: "bg-slate-100 text-slate-900 px-2 py-0.5 rounded cursor-pointer",
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("p", { className: "text-slate-600 mt-1 leading-normal", children: dialogue[roleplayStep].text })
            ]
          })
        ]
      })
    ...
    children: [
      ...
      _jsx("div", {
        ...
        children: myths.map((m) => _jsxs("div", {
          ...
          className: `p-3 rounded-xl border transition-all cursor-pointer ${activeMyth === m.id ? 'bg-amber-400/10 border-amber-400/40 shadow-md' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'}`,
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", { className: "font-black text-slate-600", children: m.myth })
                  ]
                }),
                _jsx("span", { className: "text-slate-400", children: activeMyth === m.id ? "▲" : "▼" })
              ]
            }),
            activeMyth === m.id && _jsx(motion.div, {
              initial: { height: 0, opacity: 0 },
              animate: { height: 'auto', opacity: 1 },
              className: "mt-2 pt-2 border-t border-slate-200 text-xs sm:text-sm text-amber-400 font-medium leading-relaxed",
              children: m.reality
            })
          ]
        }, m.id))
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx("p", { className: "text-xs sm:text-sm text-slate-600 leading-relaxed", children: "You have completed your first module. You are now equipped with the essential tools of money management!" })
        ]
      }),
      _jsx("div", {
        className: "p-3 bg-slate-50 border border-slate-200 rounded-xl max-w-xs mx-auto text-xs sm:text-sm text-slate-600 flex justify-center items-center gap-2",
