...
function ChoiceCard({
  ...
  return /*#__PURE__*/_jsxs(motion.div, {
    ...
    children: [/*#__PURE__*/_jsx("p", {
      ...
      children: "What is your decision?"
    }), /*#__PURE__*/_jsx("div", {
      ...
      children: showFeedback && selectedId && /*#__PURE__*/_jsx(motion.div, {
        ...
        children: /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsx("p", {
            ...
            children: selectedCorrect ? 'Correct answer! 🎯 ' + (choice.isCorrect ? choice.feedback : 'Absolutely right decision — smart move!') : choice.feedback
          })
        })
      })
    })]
...
function getAlternateOption(choice) {
  const altMap = {
    'Buy an iPhone!': 'First do FD, rest later',
    'First do FD, rest later': 'Buy an iPhone!',
    'Buy luxury on credit card': 'Make a budget and set limits',
    'Make a budget and set limits': 'Buy luxury on credit card',
    'Withdraw the full amount': 'Make an EMI plan and pay regularly',
    'Make an EMI plan and pay regularly': 'Withdraw the full amount',
    'Keep it in a savings account': 'Start SIP and enjoy compound benefits',
    'Start SIP and enjoy compound benefits': 'Keep it in a savings account',
    'Continue the EMI': 'Prepay and save on interest',
    'Prepay and save on interest': 'Continue the EMI',
    'Invest right now!': 'Build an emergency fund first',
    'Build an emergency fund first': 'Invest right now!',
    'Buying insurance is pointless': 'A term plan is essential — protection first',
    'A term plan is essential — protection first': 'Buying insurance is pointless',
    'Savings alone are enough': 'Invest to beat inflation',
    'Invest to beat inflation': 'Savings alone are enough',
    'Spend the full salary — it is my first time! 🛍️': 'First apply the 50-30-20 rule, then spend 💰',
    'First apply the 50-30-20 rule, then spend 💰': 'Spend the full salary — it is my first time! 🛍️'
  };
  // If we have a direct mapping, use it
  if (altMap[choice.text]) return altMap[choice.text];
  // Otherwise, generate a sensible opposite based on isCorrect
  if (choice.isCorrect) {
    return 'This is risky, think carefully before proceeding ⚠️';
  }
  return 'Seems right, but think deeper 🤔';
}
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("div", {
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: "Answer the question first, then proceed!"
      })]
    })]
  });
}
