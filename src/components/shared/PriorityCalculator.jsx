...
const PRIORITIES = [
  {
    ...
    barColor: '#f43f5e',
    idealPct: 30,
    tip: 'Keep rent under 25-30% of income — don\'t exceed this!'
  },
  {
    id: 'food',
    emoji: '🍔',
    ...
    barColor: '#f59e0b',
    idealPct: 15,
    tip: 'Optimize savings by avoiding daily outside meals.'
  },
  {
    id: 'transport',
    emoji: '🚗',
    ...
    barColor: '#3b82f6',
    idealPct: 8,
    tip: 'Using public transport reduces the burden on your wallet.'
  },
  {
    id: 'phone',
    emoji: '📱',
    ...
    barColor: '#06b6d4',
    idealPct: 3,
    tip: 'Choose family plans to save on utility bills.'
  },
  {
    id: 'education',
    emoji: '📚',
    ...
    barColor: '#8b5cf6',
    idealPct: 12,
    tip: 'Investing in your skills is the best compound return.'
  },
  {
    id: 'entertainment',
    emoji: '🎬',
    ...
    barColor: '#ec4899',
    idealPct: 7,
    tip: 'Cancel unnecessary memberships and try free activities.'
  },
  {
    id: 'health',
    emoji: '💊',
  ...
  },
  {
    ...
    barColor: '#22c55e',
    idealPct: 15,
    tip: 'Set aside 20% savings first (Pay Yourself First rule).'
  },
  {
    id: 'gifts',
    emoji: '🎁',
    ...
    barColor: '#f97316',
    idealPct: 3,
    tip: 'Set aside a small monthly amount separately for festive times.'
  }
];
...
export default function PriorityCalculator({ open, onClose }) {
  ...
  const aiSuggestion = useMemo(() => {
    ...
    if (savings.pct < 10) {
      return {
        type: 'danger',
        title: 'Savings priority is too low! 🚨',
        msg: `You're allocating only ${savings.pct}% of your budget to savings. Drag it into the top 3 priorities!`
      };
    }
    if (entertainment.pct > 15) {
      return {
        type: 'warning',
        title: 'Entertainment expense is over the limit 🎬',
        msg: `Spending ${entertainment.pct}% on fun activities is a bit high. Push it down a little.`
      };
    }
    if (rent.pct > 35) {
      return {
        type: 'warning',
        title: 'Rent allocation is heavy 🏠',
        msg: `Check your rent budget (${rent.pct}%). Considering a shared hostel or PG would be beneficial.`
      };
    }
    return {
      type: 'success',
      title: 'Perfect Balanced Budget! 🎯',
      msg: 'Your priority list looks balanced! Savings is in the top order. Keep it up.'
    };
  }, [allocations]);
      ...
      >
        ...
        <div className="shrink-0 px-6 py-4 border-b border-white/[0.06] bg-[#0C1021]/80 backdrop-blur-md flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-black text-white">Needs vs Wants ⚖️</h2>
