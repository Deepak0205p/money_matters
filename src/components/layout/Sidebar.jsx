...
export function Sidebar() {
  ...
  const dailyQuote = ['Financial knowledge is the greatest power', 'Small amounts matter too — start an SIP', 'Make a budget, gain your freedom', 'Today\'s money is tomorrow\'s asset'][Math.floor(Date.now() / 86400000) % 4];
