...
export default function AuthPage() {
  ...
  // Bypass login/signup screen and grant instant access
  useEffect(() => {
          ...
          {!verifyStep ? (
            ...
            >
              ...
              <button 
                ...
                className="w-full mt-4 text-xs text-zinc-400 hover:text-emerald-400 transition-colors py-2.5 flex justify-center items-center gap-2 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:border-emerald-500/30"
              >
