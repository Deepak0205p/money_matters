...
# Improved word dictionary - only common Hindi words that map cleanly to English
WORD_MAP = {
    # Pronouns
    "hum": "we", "tum": "you", "aap": "you", "woh": "that",
    "yeh": "this", "ye": "this",
    ...
    "tumhare paas": "you have", "mere paas": "I have",
    "uske paas": "he/she has", "unka": "their",
    "iska matlab hai": "this means", "yahi problem": "this is the problem",
    "sabse pehle": "first of all", "sabse important": "most important",
    "sabse common": "most common", "sabke liye": "for everyone",
    "sabko": "everyone", "koi bhi": "anyone",
    "har": "every", "kuch": "some", "sab": "all",
    "jo": "who/which", "jiski": "whose", "jiska": "whose",
    "waisa": "like that", "aise": "like this",
    "ab": "now", "tab": "then",
    "lekin": "but", "magar": "but",
    "aur": "and", "taki": "so that",
    "yehi": "this is", "wohi": "that is",
    "doston": "friends", "parents": "parents",
    "zyadatar": "mostly", "lagbhag": "approximately",
    "bilkul": "absolutely", "ekdum": "completely",
}
